...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'TP_ProWine_780d202018756a2b5323_20220127093149_archive.zip';
	const ARCHIVE_SIZE		 = '126301867';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '780d202-27093149';
    const SECONDARY_PACKAGE_HASH = 'd625bbe-27093149';
	const VERSION			 = '1.4.3';
